...
class gmii_eth_pause_stress_test extends eth_test;
  `uvm_component_utils(gmii_eth_pause_stress_test)
  
  function new (string name = "gmii_eth_pause_stress_test", uvm_component parent = null);
    super.new(name,parent);
  endfunction
