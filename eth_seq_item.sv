class eth_seq_item extends uvm_sequence_item;
  ...
  function new(string name = "transaction");
   ...
   for (int i = 0; i < `NO_OF_AGENTS; i++) begin
    ...
    /*Example MAC Soucre address    
    agnt_node[0].drv_h.sa = 48'h00_50_40_30_20_10;
    agnt_node[1].drv_h.sa = 48'h00_51_41_31_21_11;
    agnt_node[2].drv_h.sa = 48'h00_52_42_32_22_12; */
    end     
  endfunction
  ...
  constraint payload_size {soft payload.size() == ether_type;}
